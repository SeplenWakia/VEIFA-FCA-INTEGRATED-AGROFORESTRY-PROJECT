...
map.getView().fit([484142.082863, 9008556.129474, 501879.972566, 9020147.933301], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">VEIFA FCA  INTEGRATED AGROFORESTRY PROJECT</h2>';
        return titleElement;
    })(),
